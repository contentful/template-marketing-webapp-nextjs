      ...
      <div>
        <div className="view-front-splide js-view-dom-id-fc2cae5981734f7a28a1efa6572eed261fa5cd302ac886baedb390a59c3b2b42">
          <div
            ...
            data-splide='{"count":3,"type":"fade","rewind":true,"speed":500,"rewindSpeed":500,"easing":"linear"}'
          ...
          >
            <div className="splide__slider">
              <div
                ...
                aria-busy="false"
              >
                <ul className="splide__list" id="splide-78457ecf7ce-list" role="presentation">
                  {' '}
                  <li
                  ...
                  >
                    ...
                    <div className="home-slide">
                      <div className="home-slide-container">
                        <div className="home-slide-image">
                          <div className="field_slide_image field--name-field_slide_image field--name-field-slide-image">
                            {' '}
                            <img
                              src="/sites/default/files/styles/600x600/public/slide/image/417736-31614_website_hero_image_sept2023_tag_aus_600x600px_fin.jpg?itok=vbhh6xM1"
                              width={600}
                              height={600}
                              alt=""
                            />
                        ...
                        <div className="home-slide-wrapper">
                          <div className="home-slide-text-head">
                            <div className="field_text_head field--name-field_text_head field--name-field-text-head text-formatted">
                              <h2 className="">
                                A&amp;M’s Transaction Advisory Group Expands its Services to
                                Australia
                              </h2>
                              <p className="">&nbsp;</p>
                            </div>
                          ...
                          <div className="home-slide-text">
                            <div className="field_text field--name-field_text field--name-field-text text-formatted">
                              <p>
                                ...
                                underscoring its strategic growth and the firm’s continued
                                commitment to integrating its private equity services and operations
                                in the region. &nbsp;
                              </p>
                            </div>
                          </div>
                      ...
                      <div
                        style={{
                          backgroundImage:
                            'url("/sites/default/files/slide/background/417736-31614_website_hero_image_sept2023_tag_aus_1682x879_fin.jpg")',
                        }}
                  ...
                  >
                    ...
                    <div className="home-slide">
                      <div className="home-slide-container">
                        <div className="home-slide-image">
                          <div className="field_slide_image field--name-field_slide_image field--name-field-slide-image">
                            {' '}
                            <img
                              src="/sites/default/files/styles/600x600/public/slide/image/417736-31614_website_hero_image_sept2023_me_survey_600x600px_fin.jpg?itok=vYwHIYhp"
                              width={600}
                              height={600}
                              alt=""
                            />
                        ...
                        <div className="home-slide-wrapper">
                          ...
                          <div className="home-slide-text">
                            <div className="field_text field--name-field_text field--name-field-text text-formatted">
                              <p>
                                Survey results indicate concerns related to macroeconomic conditions
                                in the region are softening, with some predicting businesses will
                                still experience a level of distress for some time.
                              </p>
                            </div>
                          </div>
                          <div className="">
                      ...
                      <div
                        style={{
                          backgroundImage:
                            'url("/sites/default/files/slide/background/417736-31614_website_hero_image_sept2023_me_survey_1682x879_fin.jpg")',
                        }}
                        className="home-slide-image-bg"
                      />
                    </div>
                  ...
                  <li
                    className="splide__slide slide slide--2"
                  ...
                  >
                    ...
                    <div className="home-slide">
                      <div className="home-slide-container">
                        <div className="home-slide-image">
                          <div className="field_slide_image field--name-field_slide_image field--name-field-slide-image">
                            {' '}
                            <img
                              src="/sites/default/files/styles/600x600/public/slide/image/417736-31614_website_hero_image_sept2023_emea_award_600x600px.jpg?itok=x426DfUi"
                              width={600}
                              height={600}
                              alt=""
                            />
                        ...
                        <div className="home-slide-wrapper">
                          <div className="home-slide-text-head">
                            <div className="field_text_head field--name-field_text_head field--name-field-text-head text-formatted">
                              <h2>
                                <b className="">
                                  A&amp;M Wins RealDeals&nbsp; &nbsp; &nbsp; Private Equity
                                  Award&nbsp;
                                </b>
                              </h2>
                              <p>&nbsp;</p>
                          ...
                          <div className="home-slide-text">
                            <div className="field_text field--name-field_text field--name-field-text text-formatted">
                              <p>
                                ...
                                Diligence Provider of the Year award for demonstrating how it
                                created a bespoke value-driven service with unmatched insight into a
                                business issue.
                              </p>
                            </div>
                          </div>
                      ...
                      <div
                        style={{
                          backgroundImage:
                            'url("/sites/default/files/slide/background/417736-31614_website_hero_image_sept2023_emea_award_1682x879_fin_0.jpg")',
                        }}
                        className="home-slide-image-bg"
                      />
                    </div>
          ...
          <div className="scroll-down fixed">
            <div>Scroll Down</div>
            <img src="/themes/custom/am/images/icons/arrow-right-white-64.png" width={20} />
          </div>
        </div>
      </div>
    </div>
