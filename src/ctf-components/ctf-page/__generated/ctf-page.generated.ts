...
} from '../../../lib/shared-fragments/__generated/ctf-componentMap.generated';
    ...
    const res = await fetch('https://graphql.contentful.com/content/v1/spaces/vw5be3ki3sdd', {
      ...
      ...{
        headers: {
          ...
          Authorization: 'Bearer GM7NHP-8LZDbI758jw1ze9OYJV9rVpKcJfyjRP30ang',
        },
      },
...
export type CtfPageFieldsFragment = {
  ...
  topSectionCollection?: {
    ...
    items: Array<
      | ({ __typename?: 'ComponentCta' } & ComponentReferenceFields_ComponentCta_Fragment)
      ...
      | ({ __typename?: 'ComponentQuote' } & ComponentReferenceFields_ComponentQuote_Fragment)
      | ({
  ...
  pageContent?:
    ...
    | ({ __typename?: 'TopicBusinessInfo' } & ComponentReferenceFields_TopicBusinessInfo_Fragment)
    | ({ __typename?: 'TopicProduct' } & ComponentReferenceFields_TopicProduct_Fragment)
    | null;
...
export type CtfPageQuery = {
  ...
  pageCollection?: {
    ...
    items: Array<({ __typename?: 'Page' } & CtfPageFieldsFragment) | null>;
  } | null;
};
