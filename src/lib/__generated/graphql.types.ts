...
/** Full-width container for creating visually distinct Calls-to-Action (CTAs) [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentCta) */
...
/** Full-width container for displaying side-by-side image and copy, includes multiple layout options [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentDuplex) */
export type ComponentDuplex = Entry & {
  ...
  testRefsCollection?: Maybe<ComponentDuplexTestRefsCollection>;
};
...
/** Full-width container for displaying side-by-side image and copy, includes multiple layout options [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentDuplex) */
export type ComponentDuplexTestRefsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type ComponentDuplexFilter = {
  ...
  sys?: InputMaybe<SysFilter>;
  targetPage_exists?: InputMaybe<Scalars['Boolean']>;
  testRefsCollection_exists?: InputMaybe<Scalars['Boolean']>;
};
...
export type ComponentDuplexTestRefsCollection = {
  __typename?: 'ComponentDuplexTestRefsCollection';
...
/** Full-width container for displaying images and snappy copy; can include an optional CTA [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentHeroBanner) */
...
/** Full-width container for displaying short bits of generic information with optional icons/visuals [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentInfoBlock) */
...
/** Component that renders products in a table enabling a side-by-side comparison [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentProductTable) */
...
/** Full-width component for quotes, reviews and testimonials, includes multiple layout options [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentQuote) */
...
/** Constrained-width component for displaying ad-hoc paragraphs of text (FAQs, intros, descriptions) [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/componentTextBlock) */
...
/** Navigation content type used for powering the Footer menu [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/footerMenu) */
...
/** A group of items making up a section in the navigation menu [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/menuGroup) */
...
/** Navigation menu in the header [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/navigationMenu) */
...
/** Container that enables editors to publish a page, define its slug, select & arrange its content [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/page) */
...
/** Open Graph (OG) meta tags for optimizing SEO visibility [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/seo) */
...
/** Container for ever-green content like About us, Career pages, FAQ, Knowledge base & more [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/topicBusinessInfo) */
...
/** Container for holding info about people (article authors, company leadership, quoted customers, etc.) [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/topicPerson) */
...
/** Container for product-specific information like card definitions, features, benefits, prices & more [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/topicProduct) */
...
/** Sub-container for product features enabling re-use of generic features across different products [See type definition](https://app.contentful.com/spaces/ldl8h3zz4wha/content_types/topicProductFeature) */
