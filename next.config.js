...
module.exports = withPlugins(plugins, {
  ...
  env: {
    ...
    NEXT_PUBLIC_CONFIG_CONTENTFUL_SPACE_ID: process.env.NEXT_PUBLIC_CONFIG_CONTENTFUL_SPACE_ID,
    NEXT_PUBLIC_CONFIG_CONTENTFUL_DELIVERY_API_TOKEN: process.env.NEXT_PUBLIC_CONFIG_CONTENTFUL_DELIVERY_API_TOKEN,
    NEXT_PUBLIC_CONFIG_CONTENTFUL_PREVIEW_API_TOKEN: process.env.NEXT_PUBLIC_CONFIG_CONTENTFUL_PREVIEW_API_TOKEN,
  },
